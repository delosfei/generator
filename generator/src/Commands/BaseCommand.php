...
class BaseCommand extends Command
{
    ...
    {
        $migrationPath = config('delos.laravel_generator.path.migration', database_path('migrations/'));
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('delos.laravel_generator.path.schema_files', resource_path('model_schemas/'));
    ...
    private function saveLocaleFile()
    {
        ...
        $path = config('delos.laravel_generator.path.models_locale_files', base_path('resources/lang/en/models/'));
