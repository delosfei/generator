...
namespace Delosfei\Generator\Makes\Base;

use Delosfei\Generator\Commands\MakeBaseCommand;
use Illuminate\Filesystem\Filesystem;

trait MakerTraitBase
{
    protected $files;
    protected $scaffoldCommandObj;

    public function __construct(MakeBaseCommand $scaffoldCommand, Filesystem $files)
    {
        $this->files = $files;
